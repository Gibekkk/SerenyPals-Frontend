    ...
    return BlocBuilder<ForumCubit, ForumState>(
      builder: (context, state) {
        if (state is ForumLoaded) {
          ...
          return _buildCard(context, currentPost);
        } else {
          return const SizedBox.shrink(); // atau loader jika kamu mau
        }
      },
    );
  }

  Widget _buildCard(BuildContext context, Post currentPost) {
    return Card(
      elevation: 2.0,
          ...
          children: [
            ...
            Row(
              children: [
                GestureDetector(
                  onTap: () {
                    context.read<ForumCubit>().toggleLikePost(currentPost);
                  },
                  child: Icon(
                    currentPost.isLiked
                        ? Icons.favorite
